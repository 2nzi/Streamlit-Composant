...
if _RELEASE:
    ...
    _component_func = components.declare_component("st_image_carousel", path=build_dir)
else:
    _component_func = components.declare_component("st_image_carousel", url="http://localhost:3001")
